...
6. Edit light sources, geometry or materials.
     ...
     * Please check `command.txt` inside each folder to see how to generate results. To reproduce results in teaser, you may need to combine several editing operations together. 
